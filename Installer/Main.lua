...
local repositoryURL = "https://raw.githubusercontent.com/Nexoniarz/LavaOS/master/"
local installerURL = "Installer/"
local EFIURL = "EFI/Minified.lua"

local installerPath = "/lavaOS installer/"
...
local function title()
	...
	centrizedText(y, 0x2D2D2D, "LavaOS")
...
local installerMenu = menu:addContextMenuItem("LavaOS", 0x2D2D2D)
...
addStage(function()
	...
	if not selectedFilesystemProxy.getLabel() then
		selectedFilesystemProxy.setLabel("LavaOS HDD")
	end
	...
	component.invoke(EEPROMAddress, "setLabel", "LavaOS EFI")
