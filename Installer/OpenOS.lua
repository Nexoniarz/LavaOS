...
-- Checking if computer is tough enough for such a S T Y L I S H product as OpenOS
do
	local potatoes = {}
...
do
	local success, result = pcall(component.internet.request, "https://raw.githubusercontent.com/Nexoniarz/OpenOS/master/Installer/Main.lua")
